...
/*------------------------------------------*/
/* AcademiaThemes: Featured Page		    */
/*------------------------------------------*/
 
class academiathemes_widget_featured_pages extends WP_Widget {
	
	public function __construct() {

		parent::__construct(
			'academia-widget-featured-pages',
			esc_html__( 'Academia: Featured Pages', 'city-hall' ),
			array(
				'classname'   => 'widget-promoted-pages',
				'description' => esc_html__( 'Displays in a grid and links to multiple static pages. Best used in the \'Homepage: Content Widgets\' widgetized area.', 'city-hall' )
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			?>
			<div class="academiathemes-custom-widget widget-featured-pages">
				<?php
				...
				?>
				<ul class="widget-columns widget-columns-<?php echo esc_attr($max); ?> clearfix">
				<?php
				while ($i < $max) {
					...
					if ( $page_settings[$i]['page_id'] != 0 ) {
						...
						?><li class="widget-column widget-column-<?php echo esc_attr($z); ?> widget-column-widget site-archive-post<?php 
								...
								<div class="widget-column-widget-wrapper clearfix">
									...
									<div class="entry-preview">
										<div class="entry-preview-wrapper clearfix">
											...
											if ($show_excerpt == 1) { echo academiathemes_helper_display_excerpt($post); }
											if ($show_button == 1) { echo academiathemes_helper_display_button_readmore($post); } 
											?>
				...
				</ul><!-- .widget-columns .widget-columns-<?php echo esc_attr($show_num); ?> .widget-columns-widget .clearfix-->
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page1' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
			<select id="<?php echo $this->get_field_id('page1'); ?>" name="<?php echo $this->get_field_name('page1'); ?>">
				<option value="0"><?php esc_html_e('Choose page:', 'city-hall'); ?></option>
				<?php
				$pages = get_pages();
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page2' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page3' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page4' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_photo' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Display Featured Image', 'city-hall'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Display Title', 'city-hall'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 6px;"><?php esc_html_e('Display Page Excerpt', 'city-hall'); ?></label>
		</p>

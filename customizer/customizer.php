    ...
    class ACADEMIATHEMES_Customizer {
        ...
        private function get_panels() {
            return apply_filters( 'academiathemes_customizer_panels', array(
                'general'      => array( 'title' => esc_html__( 'Theme Settings', 'city-hall' ), 'priority' => 4000 ),
                'color-scheme' => array( 'title' => esc_html__( 'Theme Colors', 'city-hall' ), 'priority' => 5000 ),
            ) );
        }
...
// Extra styles
function city_hall_customizer_stylesheet() {
    
    // Stylesheet
    wp_enqueue_style( 'city-hall-customizer-css', get_template_directory_uri().'/academia-admin/css/customizer-styles.css', NULL, NULL, 'all' );
    
}

add_action( 'customize_controls_print_styles', 'city_hall_customizer_stylesheet' );
 ...
 */
function city_hall_customize_register( $wp_customize ) {

    // Custom help section
    class City_Hall_WP_Help_Customize_Control extends WP_Customize_Control {
        public $type = 'text_help';
        public function render_content() {

            echo '
                <div class="bnt-customizer-help">
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.academiathemes.com/free-wordpress-themes/city-hall-lite/?utm_source=dashboard&utm_medium=customizer-page&utm_campaign=city-hall-lite&utm_content=official-theme-page-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-info"></span>
                        '.esc_html__( 'Official Theme Page', 'city-hall' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://demo.academiathemes.com/?theme=city-hall-lite&utm_source=dashboard&utm_medium=customizer-page&utm_campaign=city-hall-lite&utm_content=theme-doc-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-book"></span>
                        '.esc_html__( 'Theme Documentation', 'city-hall' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://wordpress.org/support/theme/city-hall/" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-sos"></span>
                        '.esc_html__( 'Support Forum', 'city-hall' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://wordpress.org/support/theme/city-hall/reviews/" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-heart"></span>
                        '.esc_html__( 'Rate City Hall', 'city-hall' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://www.academiathemes.com/themes/city-hall/?utm_source=dashboard&utm_medium=customizer-page&utm_campaign=city-hall-lite&utm_content=upgrade-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-superhero"></span>
                        '.esc_html__( 'Upgrade to City Hall Pro', 'city-hall' ).'
                        <span class="customize-action">'.esc_html__( 'The PRO version comes with additional custom widgets, templates, customization options and priority support!', 'city-hall' ).'</span>
                        <br><span class="button button-primary">'.esc_html__( 'View City Hall Pro', 'city-hall' ).'</span>
                    </a>
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                ...
                'render_callback' => 'city_hall_customize_partial_blogname',
            )
        );
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                ...
                'render_callback' => 'city_hall_customize_partial_blogdescription',
            )
        );
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                'selector'        => '.site-logo',
                'render_callback' => 'city_hall_customize_partial_site_logo',
            )
        );

        $wp_customize->add_section( 
            'city_hall_theme_support', 
            array(
                'title' => esc_html__( 'Theme Help & Support', 'city-hall' ),
                'priority' => 19,
            ) 
        );
        ...
        $wp_customize->add_control(
            new City_Hall_WP_Help_Customize_Control(
            $wp_customize,
            'city_hall_support', 
                array(
                    'section' => 'city_hall_theme_support',
                    'type' => 'text_help',
                )
            )
        );
...
add_action( 'customize_register', 'city_hall_customize_register' );

/**
 * PARTIAL REFRESH FUNCTIONS
 * */
if ( ! function_exists( 'city_hall_customize_partial_blogname' ) ) {
    /**
     * Render the site title for the selective refresh partial.
     */
    function city_hall_customize_partial_blogname() {
        bloginfo( 'name' );
    }
}

if ( ! function_exists( 'city_hall_customize_partial_blogdescription' ) ) {
    /**
     * Render the site description for the selective refresh partial.
     */
    function city_hall_customize_partial_blogdescription() {
        bloginfo( 'description' );
    }
}

if ( ! function_exists( 'city_hall_customize_partial_site_logo' ) ) {
    /**
     * Render the site logo for the selective refresh partial.
     *
     * Doing it this way so we don't have issues with `render_callback`'s arguments.
     */
    function city_hall_customize_partial_site_logo() {

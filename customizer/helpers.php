...
if ( ! function_exists( 'city_hall_get_categories' ) ) :
/**
 ...
 */
function city_hall_get_categories() {
    ...
    return apply_filters( 'city_hall_get_categories', $choices );
}
endif;

if ( ! function_exists( 'city_hall_sanitize_categories' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function city_hall_sanitize_categories( $value ) {

    $choices = city_hall_get_categories();
    $valid   = array_keys( $choices );
...
if ( ! function_exists( 'city_hall_get_tags' ) ) :
/**
...
function city_hall_get_tags() {
    ...
    return apply_filters( 'city_hall_get_tags', $choices );
}
endif;

if ( ! function_exists( 'city_hall_sanitize_tags' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function city_hall_sanitize_tags( $value ) {

    $choices = city_hall_get_tags();
    $valid   = array_keys( $choices );
